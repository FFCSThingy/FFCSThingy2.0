...
import {
	Container, Form, Button, Row, Col, ToggleButton, ToggleButtonGroup, Alert,
	...
	handleChanges = (value, event) => {
		...
		if (this.state[fieldName] === fieldVal) {
			...
			this.setState((prevState) => ({
				priorityList: prevState.priorityList.filter((item) => item !== fieldName),
			}));
		} else {
			this.setState((prevState) => ({
				priorityList: prevState.priorityList.push(fieldName),
			}));
		}
