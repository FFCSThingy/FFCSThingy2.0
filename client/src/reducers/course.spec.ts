...
describe('course reducer', () => {
	...
	describe('fetchHeatmap thunk', () => {
		it('should set loading state when heatmap call is pending', () => {
			expect.hasAssertions();
		...
		it('should handle a successful heatmap call', () => {
			expect.hasAssertions();
			const sampleData = {
				heatmap: [
					{
		...
		it('should handle a failed heatmap call', () => {
			expect.hasAssertions();
	...
	describe('fetchAllCourseLists thunk', () => {
		it('should handle a successful course lists call', () => {
			expect.hasAssertions();
			const sampleData = {
				courseList: {
					ZZZ1001: {
